...
def filter_data():
    try:
        ...
        column_data = filtered_df[category_column_value].tolist()

        result_text.set(f"Filtered Results:\n{filtered_df.to_string(index=False)}\n\nColumn Data:\n{', '.join(column_data)}")
...
category_combobox.grid(row=2, column=1, padx=10, pady=10, columnspan=2, sticky="ew")
